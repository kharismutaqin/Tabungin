      ...
      <div className="entry-card animate-slide-up">
        ...
        <form onSubmit={handleSubmit} className="flex flex-col gap-4">
          <div className="input-group">
            <label htmlFor="groupKey" style={{ display: "flex", alignItems: "center", gap: "6px" }}>
            ...
            {error && (
              <span style={{ color: "var(--primary-hover)", fontSize: "0.875rem" }}>{error}</span>
            )}
          </div>

          <button type="submit" className="btn btn-primary w-full" style={{ fontSize: "1.05rem" }}>
            🚀 Masuk Sekarang
          </button>
        </form>

        <p style={{ marginTop: "1.5rem", fontSize: "0.8rem", color: "var(--text-muted)", lineHeight: 1.7 }}>
